// ISO-3166 country list, English short names. Used for both country dropdowns
// (requester + pilgrim) and for normalizing values stored in the DB.
const COUNTRIES = [
  ...
  { code: 'XK', name: 'Kosovo' }, { code: 'KW', name: 'Kuwait' },
...
module.exports = { COUNTRIES, nameFor };
